...
import { ArrowLeft, Mail, Phone, MapPin, Calendar, Building2, GraduationCap, Home, CreditCard, ClipboardCheck } from "lucide-react";
...
import { getStudentByRoll } from "@/lib/generateStudents";
...
export default function StudentProfile() {
  const [, params] = useRoute("/student/:roll");
  const [, setLocation] = useLocation();
  const { isAdmin, student: loggedInStudent } = useAuth();
    ...
    return (
      <div className="p-6">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <Button onClick={() => setLocation(isAdmin ? "/students" : "/profile")}>
            Go Back
          </Button>
        </div>
      </div>
        ...
        <TabsContent value="academics" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current semester subjects and grades</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <TabsContent value="fee" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Payment details and dues</CardDescription>
            </CardHeader>
            ...
            <CardContent>
              {student.hostelName ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">This student is not enrolled in hostel accommodation.</p>
                </div>
              )}
            </CardContent>
          </Card>
